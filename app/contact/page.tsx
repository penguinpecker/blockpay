...
function ContactRow({
  ...
  return (
    <li>
      <a
        href={href}
        className="group flex items-start gap-3 rounded-xl border border-transparent px-2 py-1.5 transition-colors hover:border-[rgba(74,222,128,0.18)] hover:bg-[rgba(74,222,128,0.05)]"
      >
        <span
