          ...
          <div className="mx-auto max-w-4xl card-frame px-8 py-10 md:px-12">
            <div className="overflow-x-auto">
              <table className="w-full text-left text-sm">
                <thead>
                  <tr className="border-b border-[rgba(74,222,128,0.35)]">
                    <th className="pb-4 font-display text-xs uppercase tracking-[0.16em] text-zinc-500">
                      Pair
                    </th>
                    <th className="pb-4 font-display text-xs uppercase tracking-[0.16em] text-zinc-500">
                      Rate
                ...
                <tbody>
                  {rows.map((r) => (
                    <tr
                      key={r.pair}
                      className="border-b border-[rgba(74,222,128,0.12)] last:border-0"
                    >
                      <td className="py-4 font-display text-base font-semibold text-white">
                        {r.pair}
                      </td>
                      <td className="py-4 font-mono text-sm text-accent">
                        {r.rate}
                      </td>
                      <td className="py-4 font-mono text-sm text-zinc-300">
                        {r.inverse}
                      </td>
                      <td className="py-4 text-sm text-zinc-400">{r.source}</td>
                    </tr>
                  ))}
                </tbody>
              </table>
